...
class PathFinderTest {
    ...
    fun `Markes start and end as part of way`() {
        ...
        assertEquals(marked, pathFinder.addPath(mapString))
    }
    ...
    fun `Mark way around wall`() {
        ...
        // Adjusted to fit actual found way. The cost is equivalent.
        assertEquals(marked, pathFinder.addPath(mapString))
    }
...
BB....BBB...B.B...B.....B.B..B.B....B.B.B...B.B..BBBBBB.B....B...BB..BBB...B.BB....B.........BB..B..
    ...
    @Test
    fun `navigating on graph without path should throw error`() {
        val mapString = """
        .........B..........
        ........XBS.........
        .........B..........
        ...
        assertThrows<IllegalArgumentException>("No path found!") { pathFinder.addPath(mapString) }
    }
}